...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'administration.pharmacie.admin' => 'getAdministration_Pharmacie_AdminService',
            'administration.pharmacien.admin' => 'getAdministration_Pharmacien_AdminService',
    ...
    /*
     * Gets the 'administration.pharmacie.admin' service.
     *
     * @return \Administration\PharmacieBundle\Admin\PharmacieAdmin A Administration\PharmacieBundle\Admin\PharmacieAdmin instance
     */
    protected function getAdministration_Pharmacie_AdminService()
    {
        $instance = new \Administration\PharmacieBundle\Admin\PharmacieAdmin('administration.pharmacie.admin', 'Administration\\PharmacieBundle\\Entity\\Pharmacie', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('AdministrationPharmacieBundle');
    ...
    /*
     * Gets the 'administration.pharmacien.admin' service.
     *
     * @return \Administration\PharmacieBundle\Admin\PharmacienAdmin A Administration\PharmacieBundle\Admin\PharmacienAdmin instance
     */
    protected function getAdministration_Pharmacien_AdminService()
    {
        $instance = new \Administration\PharmacieBundle\Admin\PharmacienAdmin('administration.pharmacien.admin', 'Administration\\PharmacieBundle\\Entity\\Pharmacien', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('AdministrationPharmacienBundle');
        $instance->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $instance->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'progestix', 'user' => 'root', 'password' => 'Progestix@2017#', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'AdministrationPharmacieBundle' => 'Administration\\PharmacieBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3d1f237af4c04b3e11c7387f50df38097071193d14070f4694cfb6269ed94344');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group', 2 => 'administration.pharmacie.admin', 3 => 'administration.pharmacien.admin'));
        $instance->setAdminGroups(array('sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class=\'fa fa-users\'></i>', 'roles' => array(), 'on_top' => false, 'items' => array(0 => array('admin' => 'sonata.user.admin.user', 'label' => 'users', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'sonata.user.admin.group', 'label' => 'groups', 'route' => '', 'route_params' => array(), 'route_absolute' => true))), 'Administration globale' => array('label' => 'Administration globale', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'items' => array(0 => array('admin' => 'administration.pharmacie.admin', 'label' => 'Pharmacie', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'administration.pharmacien.admin', 'label' => 'Pharmacien', 'route' => '', 'route_params' => array(), 'route_absolute' => true)))));
        $instance->setAdminClasses(array('Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group'), 'Administration\\PharmacieBundle\\Entity\\Pharmacie' => array(0 => 'administration.pharmacie.admin'), 'Administration\\PharmacieBundle\\Entity\\Pharmacien' => array(0 => 'administration.pharmacien.admin')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group', 2 => 'administration.pharmacie.admin', 3 => 'administration.pharmacien.admin'), $this);
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57de84360ec026.00263804'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57de84360ec026.00263804')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'Progestix@2017#',
