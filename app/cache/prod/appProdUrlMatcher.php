...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // administration_pharmacie_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'administration_pharmacie_homepage');
            }

            return array (  '_controller' => 'Administration\\PharmacieBundle\\Controller\\DefaultController::indexAction',  '_route' => 'administration_pharmacie_homepage',);
        }

        // pharmacie_pharmacien_default_index
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'pharmacie_pharmacien_default_index');
            }

            return array (  '_controller' => 'Pharmacie\\PharmacienBundle\\Controller\\DefaultController::indexAction',  '_route' => 'pharmacie_pharmacien_default_index',);
        }

        // pharmacie_pharmacien_general_accueilpharmacien
        if ($pathinfo === '/accueil/pharmacien') {
            return array (  '_controller' => 'Pharmacie\\PharmacienBundle\\Controller\\GeneralController::accueilPharmacienAction',  '_route' => 'pharmacie_pharmacien_general_accueilpharmacien',);
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/administration/pharmacie/pharmacie')) {
                // admin_administration_pharmacie_pharmacie_list
                if ($pathinfo === '/admin/administration/pharmacie/pharmacie/list') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'administration.pharmacie.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacie_list',  '_route' => 'admin_administration_pharmacie_pharmacie_list',);
                }

                // admin_administration_pharmacie_pharmacie_create
                if ($pathinfo === '/admin/administration/pharmacie/pharmacie/create') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'administration.pharmacie.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacie_create',  '_route' => 'admin_administration_pharmacie_pharmacie_create',);
                }

                // admin_administration_pharmacie_pharmacie_batch
                if ($pathinfo === '/admin/administration/pharmacie/pharmacie/batch') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'administration.pharmacie.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacie_batch',  '_route' => 'admin_administration_pharmacie_pharmacie_batch',);
                }

                // admin_administration_pharmacie_pharmacie_edit
                if (preg_match('#^/admin/administration/pharmacie/pharmacie/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_administration_pharmacie_pharmacie_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'administration.pharmacie.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacie_edit',));
                }

                // admin_administration_pharmacie_pharmacie_delete
                if (preg_match('#^/admin/administration/pharmacie/pharmacie/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_administration_pharmacie_pharmacie_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'administration.pharmacie.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacie_delete',));
                }

                // admin_administration_pharmacie_pharmacie_show
                if (preg_match('#^/admin/administration/pharmacie/pharmacie/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_administration_pharmacie_pharmacie_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'administration.pharmacie.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacie_show',));
                }

                // admin_administration_pharmacie_pharmacie_export
                if ($pathinfo === '/admin/administration/pharmacie/pharmacie/export') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'administration.pharmacie.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacie_export',  '_route' => 'admin_administration_pharmacie_pharmacie_export',);
                }

                if (0 === strpos($pathinfo, '/admin/administration/pharmacie/pharmacien')) {
                    // admin_administration_pharmacie_pharmacien_list
                    if ($pathinfo === '/admin/administration/pharmacie/pharmacien/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'administration.pharmacien.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacien_list',  '_route' => 'admin_administration_pharmacie_pharmacien_list',);
                    }

                    // admin_administration_pharmacie_pharmacien_create
                    if ($pathinfo === '/admin/administration/pharmacie/pharmacien/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'administration.pharmacien.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacien_create',  '_route' => 'admin_administration_pharmacie_pharmacien_create',);
                    }

                    // admin_administration_pharmacie_pharmacien_batch
                    if ($pathinfo === '/admin/administration/pharmacie/pharmacien/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'administration.pharmacien.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacien_batch',  '_route' => 'admin_administration_pharmacie_pharmacien_batch',);
                    }

                    // admin_administration_pharmacie_pharmacien_edit
                    if (preg_match('#^/admin/administration/pharmacie/pharmacien/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_administration_pharmacie_pharmacien_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'administration.pharmacien.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacien_edit',));
                    }

                    // admin_administration_pharmacie_pharmacien_delete
                    if (preg_match('#^/admin/administration/pharmacie/pharmacien/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_administration_pharmacie_pharmacien_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'administration.pharmacien.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacien_delete',));
                    }

                    // admin_administration_pharmacie_pharmacien_show
                    if (preg_match('#^/admin/administration/pharmacie/pharmacien/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_administration_pharmacie_pharmacien_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'administration.pharmacien.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacien_show',));
                    }

                    // admin_administration_pharmacie_pharmacien_export
                    if ($pathinfo === '/admin/administration/pharmacie/pharmacien/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'administration.pharmacien.admin',  '_sonata_name' => 'admin_administration_pharmacie_pharmacien_export',  '_route' => 'admin_administration_pharmacie_pharmacien_export',);
                    }
