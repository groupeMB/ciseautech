...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('pugx_autocompleter.filter.doctrine_subscriber', 'PUGX\\AutocompleterBundle\\Listener\\FilterSubscriber');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'ciseautech', 'user' => 'root', 'password' => 'YENGUEÇÀ', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Couture/GestionBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Clientele/GestionBundle/Entity')));
        ...
        $d->addDriver($c, 'Couture\\GestionBundle\\Entity');
        $d->addDriver($c, 'Clientele\\GestionBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'CoutureGestionBundle' => 'Couture\\GestionBundle\\Entity', 'ClienteleGestionBundle' => 'Clientele\\GestionBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_aeaeb2e3fdaa90bade21b74ea2ccf679aeaaabe532c7d31ac53d3270306a40f9');
    ...
    /**
     * Gets the 'pugx_autocompleter.autocomplete' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PUGX\AutocompleterBundle\Form\Type\AutocompleteType A PUGX\AutocompleterBundle\Form\Type\AutocompleteType instance
     */
    protected function getPugxAutocompleter_AutocompleteService()
    {
        return $this->services['pugx_autocompleter.autocomplete'] = new \PUGX\AutocompleterBundle\Form\Type\AutocompleteType($this->get('doctrine'));
    }

    /**
     * Gets the 'pugx_autocompleter.filter.doctrine_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PUGX\AutocompleterBundle\Listener\FilterSubscriber A PUGX\AutocompleterBundle\Listener\FilterSubscriber instance
     */
    ...
    /**
     * Gets the 'pugx_autocompleter.filter_autocomplete' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PUGX\AutocompleterBundle\Form\Type\AutocompleteFilterType A PUGX\AutocompleterBundle\Form\Type\AutocompleteFilterType instance
     */
    protected function getPugxAutocompleter_FilterAutocompleteService()
    {
        return $this->services['pugx_autocompleter.filter_autocomplete'] = new \PUGX\AutocompleterBundle\Form\Type\AutocompleteFilterType($this->get('doctrine'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Couture/GestionBundle/Resources/views'), 'CoutureGestion');
        $instance->addPath(($this->targetDirs[3].'/src/Clientele/GestionBundle/Resources/views'), 'ClienteleGestion');
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('587b7259b382d8.69515999'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('587b7259b382d8.69515999')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CoutureGestionBundle' => 'Couture\\GestionBundle\\CoutureGestionBundle',
                ...
                'ClienteleGestionBundle' => 'Clientele\\GestionBundle\\ClienteleGestionBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'ciseautech',
            'database_user' => 'root',
            'database_password' => 'YENGUEÇÀ',
            ...
            'sonata.core.form.types' => array(
                ...
                71 => 'pugx_autocompleter.autocomplete',
                72 => 'pugx_autocompleter.filter_autocomplete',
            ),
